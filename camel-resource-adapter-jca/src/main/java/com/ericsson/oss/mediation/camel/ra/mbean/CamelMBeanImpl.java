 ...
 */
package com.ericsson.oss.mediation.camel.ra.mbean;
 ...
 * @version $Revision: $
 */
public class CamelMBeanImpl implements CamelMBean {
	/** JNDI name */
	private static final String JNDI_NAME = "java:/eis/Camel";
	 ...
	 * @return DataFlow
	 */
	private DataFlow getConnection() throws Exception {
		InitialContext context = new InitialContext();
		DataFlowContextFactory factory = (DataFlowContextFactory) context
				.lookup(JNDI_NAME);
		DataFlow conn = factory.getDataFlowImplementation();
		if (conn == null) {
