 ...
 * @version $Revision: $
 */
public class CamelManagedConnection implements ManagedConnection, XAResource, LocalTransaction {

    /** The logger */
    private static Logger log = LoggerFactory.getLogger(CamelManagedConnection.class);
     ...
     *            mcf
     */
    public CamelManagedConnection(final CamelManagedConnectionFactory mcf) throws ResourceException {
        this.mcf = mcf;
        this.logwriter = null;
    ...
    /**
     * Creates a new flow handle for the underlying physical flow represented by the ManagedConnection instance.
     * 
     * @param subject
    ...
    /**
     * Used by the container to change the association of an application-level flow handle with a ManagedConneciton instance.
     * 
     * @param flow
    ...
    /**
     * Removes an already registered flow event listener from the ManagedConnection instance.
     * 
     * @param listener
    ...
    /**
     * Gets the metadata information for this flow's underlying EIS resource manager instance.
     * 
    ...
    public XAResource getXAResource() throws ResourceException {
        log.trace("getXAResource called, returning {}", this);
        return this;
    }
    ...
    public void processRequest(final CamelRequest request) throws Exception {
        ...
        //        try {
        //            Thread.currentThread().setContextClassLoader(this.camelRa.getClass().getClassLoader());
        request.run();
        request.release();
